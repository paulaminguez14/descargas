...
class EtiquetaServicioImplTest {
    ...
    void testObtenerTodasLasEtiquetas() {
        List<Etiqueta> etiquetas = Arrays.asList(
                new Etiqueta("Etiqueta 1", "Descripcion 1", true, 1, "azul"),
                new Etiqueta("Etiqueta 2", "Descripcion 2", false, 3, "amarillo")
        );
    ...
    void testActualizarEtiquetaSinDuplicados() {
        ...
        Etiqueta etiquetaActualizada = new Etiqueta("Etiqueta Actualizada", "Descripción Actualizada", false, 2, "amarillo");
        ...
        assertEquals("amarillo", resultado.getColor());
    }
